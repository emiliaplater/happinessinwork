...
def algorithmModule1(threshold_frame, frame) -> int:
    circles = cv2.HoughCircles(threshold_frame, cv2.HOUGH_GRADIENT, dp=1, minDist=50, param1=8.5, param2=8.5, minRadius=5, maxRadius=100)
